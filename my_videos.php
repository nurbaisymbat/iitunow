			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Videos of <?php echo $_SESSION['user_name']; ?></h1>
							</header>
							<section class="tiles">
							<?php
								$query = $connection->query("SELECT * FROM video_table WHERE user_id=".$_SESSION['user_id']." ORDER BY add_date DESC ");
							?>
							<?php $i=0; $j=1;
								if($query->num_rows === 0){
									echo "<h4> You have not uploaded video yet. <a href=\"add_video.php\">Add it Now!</a></h4>";
								}
